...
/**
 * Template for rendering the Schedule UI.
 * 
 * Variables available:
...
<div class="statpal-livescores-container" data-paginated="true">
    ...
    <div class="statpal-ls-header">
        ...
        <div class="statpal-ls-header-col four">Scheduled Games</div>
    </div>
